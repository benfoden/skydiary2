  ...
  return (
    <div className="flex h-full w-full flex-col items-center gap-12 pb-4">
      <textarea
        ...
        className="min-h-full w-full resize-none rounded-xl border-none bg-white/20 px-8 py-6 focus:outline-none sm:max-w-5xl sm:rounded-3xl sm:px-16 sm:py-12 dark:bg-black/80 dark:text-[#DCDCDC]"
        autoFocus
